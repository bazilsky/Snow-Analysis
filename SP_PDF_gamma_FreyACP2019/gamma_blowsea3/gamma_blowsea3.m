%% gamma_blowsea3
% pseudo 2-parameter gamma distribution fitting to real data with y-scale 
% based on gamma_testbed.m by Phil Anderson, 27th Aug 2012; % modified 14th Feb 2014
%
%
...
h = @f_3p_gamma_diff;       % name of function for search  
data.x = x;                 % structure for the data
data.y = pdf;
p_init = [85 1 1e3];         % 1st guess for search [shape scale yscale];
...
pdf_ret = f_build_3p_gamma(x_fine,p_ret);   % calc the curve

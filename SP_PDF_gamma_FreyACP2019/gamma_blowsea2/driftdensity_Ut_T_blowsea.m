...
figure(1)
plot(time_avg,diff,'r-','LineWidth',2)
...
% this is a completely new part of the code, m and q slices were the old
% part to try and estimate where the slope the drift density vs time plot
...
hold on
plot(T_fine,Ut+2*delta,'r--',T_fine,Ut-2*delta,'r--')
plot(T_noaa_2m_2,vel_zero,'b.','MarkerSize',20)

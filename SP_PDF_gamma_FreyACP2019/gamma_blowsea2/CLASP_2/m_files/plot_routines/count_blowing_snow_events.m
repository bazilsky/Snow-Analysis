...
start_date = datenum('02-Dec-2019 00:00');
end_date = datenum('09-May-2020 00:00');
% end_date = datenum('23-Dec-2019 00:00');
date_increment = 10;  % 10 days increment
current_date = start_date;

% 
% t1 = datenum('02-Dec-2019 00:00'); 
% t2 = datenum('12-Dec-2019 00:00'); %

%t1 = datenum('16-Mar-2020 23:15'); 
%t2 = datenum('31-Mar-2020 23:26'); %
...
%     figure(counter)
    openfig('/Users/ananth/Desktop/bas_github_scripts/bas_github_scripts/SP_PDF_gamma_FreyACP2019/gamma_blowsea2/CLASP_2/data/temp3.fig','reuse')

%     h = get(gcf,'children'); % get axes handles
    h = get(gcf,'children'); % get all child handles
    h = h(strcmp(get(h, 'Type'), 'axes')); % keep only those of type 'axes'

    t1 = current_date;
    t2 = min(t1+date_increment,end_date);
...
%     set(gca,'XLim',[t1 t2],'YAxisLocation','left');
    ...
    save_name = strcat('figure_',int2str(counter),'.png')
    save_path = strcat('/Users/ananth/Desktop/new_data/save_plots_BSn/',save_name)

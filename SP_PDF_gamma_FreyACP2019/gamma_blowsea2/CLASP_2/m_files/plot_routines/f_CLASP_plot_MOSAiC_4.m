...
v = [0.1 10 100 1e3 1e4 1e5 1e6 1e7]; % color scheme; include zero counts
vl = {'10^-1' '10^1' '10^2' '10^3' '10^4' '10^5' '10^6' '10^7'}; % color scheme labels
...
caxis([0 log(v(end))]); % scale colormap of this plot


s = get(gca,'Position'); % remember axis position
%colorbar('EastOutside');
%colorbar('eastoutside', 'Scale', 'log');

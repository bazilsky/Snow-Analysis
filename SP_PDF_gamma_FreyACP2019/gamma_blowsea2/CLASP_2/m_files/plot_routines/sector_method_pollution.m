...
wind_u_org = wind_arr.u(t_filter_3);
wind_v_org = wind_arr.v(t_filter_3);
wind_w_org = wind_arr.w(t_filter_3);
wind_time_org = wind_arr.time_arr(t_filter_3);
...
wind_u_2 = double(wind_u_2);
wind_v_2 = double(wind_v_2);
wind_w_2 = double(wind_w_2);

...
t1 = datenum('02-Jul-2013 23:15'); t2 = datenum('14-Jul-2013 23:26');
...
% n2 = find(DATA.U10m(:,1)>=velocity_bins(i) & DATA.U10m(:,1)<velocity_bins(i+1));

n = find((DATA.t(:,1) >= t1 & DATA.t(:,1) < t2) & (DATA.U10m_ex(:,1) >= 8 & DATA.U10m_ex(:,1) < 10));
...
str = sprintf('\\alpha %5.2f, \\beta %5.2f , \\alpha\\beta %3.0f \\mum',...
    p_ret(1),p_ret(2), p_ret(1).*p_ret(2));
